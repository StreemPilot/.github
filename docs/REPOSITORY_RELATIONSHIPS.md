...
# Repository relationships for `StreemPilot`
...
- Inventory digest: `sha256:1814e11311d892a4e2c6e223c95e5f8aeb545ed578c9b3f22986349f09b82295`

## Immutable routing identity

| Field | Value |
|---|---|
| Mapping ID | `context:streempilot` |
| GitHub owner ID | `311150932` |
...
|---|---|---|---|
| `StreemPilot/.github` | `public` | `community-health`, `governance`, `relationship-registry` | no |
