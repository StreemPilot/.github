...
This GitHub account maintains software, infrastructure, research, and supporting documentation under the [`StreemPilot`](https://github.com/StreemPilot) GitHub owner.

Planning and delivery context is tracked in [github.com/streempilot](https://linear.app/denman/project/githubcomstreempilot-e8b8f6dee124). Public contribution, security, and governance defaults are maintained in [`.github`](https://github.com/StreemPilot/.github).
